...
- `harness/scenarios/chat.yml` (versão 6): abertura direta, quota, lista/estado vazio, primeira mensagem, foto idempotente moderada, entrega/leitura/retry, não lidas, silenciamento, push neutro, álbum contextual sem prévia privada e denúncia específica na conversa ativa.
