...
import shop.vibeali.app.ui.AgeVerificationScreen
import shop.vibeali.app.ui.DIDIT_IDENTITY_VERIFICATION_TERMS_URL
import shop.vibeali.app.ui.DIDIT_VERIFICATION_PRIVACY_NOTICE_URL
...
class AgeVerificationScreenTest {
    ...
    fun completeAndCancelledDeepLinksResolveToMainActivity() {
        ...
        listOf("complete", "cancelled").forEach { result ->
            val intent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("vibeali://age-verification/$result"),
