...
- Ao incluir uma foto de perfil, de álbum privado ou de conversa, o Android oferece `Tirar foto agora` e `Escolher da galeria`. A captura usa o aplicativo de câmera do sistema com um arquivo temporário privado, sem conceder ao VibeAli permissão permanente de câmera, e passa pelo mesmo processamento e pelas mesmas regras do fluxo escolhido.
...
- Titular e destinatário com concessão vigente podem tocar em uma miniatura já carregada para abrir uma prévia ampliada; fechar a prévia não altera o álbum nem prolonga a autorização da mídia.
...
- **AC-PHOTO-05:** perfil, álbum e conversa oferecem câmera e galeria; cancelar ou falhar na câmera remove o arquivo temporário, não envia bytes e não cria conteúdo.
...
- **AC-ALBUM-11:** tocar em uma miniatura válida abre a prévia ampliada para o titular ou destinatário ainda autorizado; mídia inválida, revogada ou já descartada não abre a prévia.
