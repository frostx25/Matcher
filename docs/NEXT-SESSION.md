...
- Android: 56 testes unitários e 18 testes instrumentados aprovados; lint, build, instalação e abertura do APK debug também aprovados no Samsung SM-A315G com Android 12/API 31.
- O teste no aparelho revelou e validou a correção de uma corrida entre o descarte manual do bitmap privado e o renderizador do Compose; o APK corrigido abriu sem crash.
